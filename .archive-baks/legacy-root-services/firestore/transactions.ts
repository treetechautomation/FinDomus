  ...
  return snap.docs.map((doc) => {
    ...
    return {
      ...
      date: data.date,
        ...
        installmentKey: data.installmentKey,
        installmentCurrent: data.installmentCurrent,
        installmentTotal: data.installmentTotal,
        importSessionName: data.importSessionName,
      ...
      merchant: data.merchant,
        ...
        financialSourceType: data.financialSourceType,
