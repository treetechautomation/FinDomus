...
export function buildLearningFingerprint(text: string) {
  ...
  return normalizeLearningText(text)
    ...
    // remove sequências numéricas grandes
    .replace(/\b\d{3,}\b/g, ' ')
