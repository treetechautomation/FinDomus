...
interface TaxableIncomeItem {
  source: string;
  value: number;
}

interface DeductibleExpenseItem {
  type: string;
  description: string;
  value: number;
}

interface MobileImpostoDeRendaViewProps {
  taxableIncome: TaxableIncomeItem[];
  deductibleExpenses: DeductibleExpenseItem[];
}

export default function MobileImpostoDeRendaView({ taxableIncome, deductibleExpenses }: MobileImpostoDeRendaViewProps) {
  return (
