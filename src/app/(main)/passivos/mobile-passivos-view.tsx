...
export interface MobilePassivosViewProps {
  activeLiabilities: Liability[];
  totalLiabilities: number;
  monthlyProjection: ReturnType<typeof buildMonthlyProjection>;
  projectionTimeline: ReturnType<typeof buildProjectionTimeline>;
  totalMonthlyCommitment: number;
}

export function MobilePassivosView({
  activeLiabilities,
  totalLiabilities,
  monthlyProjection,
  projectionTimeline,
  totalMonthlyCommitment,
}: MobilePassivosViewProps) {
  return (
